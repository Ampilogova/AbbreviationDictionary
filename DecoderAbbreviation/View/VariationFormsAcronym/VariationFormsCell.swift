//
//  VariationFormsCell.swift
//  DecoderAbbreviation
//
//  Created by Tatiana Ampilogova on 8/2/22.
//

import UIKit

class VariationFormsCell: UITableViewCell {
    ...
    func configure(with model: VariationForms) {
        self.acronymLabel.text = model.fullForms
